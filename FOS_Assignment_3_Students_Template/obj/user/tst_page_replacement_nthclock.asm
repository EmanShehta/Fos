...
obj/user/tst_page_replacement_nthclock:     file format elf32-i386
...
//	cprintf("envID = %d\n",envID);
  ...
  80033b:	3d 00 80 80 00       	cmp    $0x808000,%eax
  800340:	74 14                	je     800356 <_main+0x31e>
  800342:	83 ec 04             	sub    $0x4,%esp
  800345:	68 b4 20 80 00       	push   $0x8020b4
  80034a:	6a 39                	push   $0x39
  80034c:	68 44 20 80 00       	push   $0x802044
  800351:	e8 79 03 00 00       	call   8006cf <_panic>
		if( ROUNDDOWN(myEnv->__uptr_pws[1].virtual_address,PAGE_SIZE) !=  0x809000)  panic("Page nth clock algo failed.. trace it by printing WS before and after page fault");
  ...
  800371:	3d 00 90 80 00       	cmp    $0x809000,%eax
  800376:	74 14                	je     80038c <_main+0x354>
  800378:	83 ec 04             	sub    $0x4,%esp
  80037b:	68 b4 20 80 00       	push   $0x8020b4
  800380:	6a 3a                	push   $0x3a
  800382:	68 44 20 80 00       	push   $0x802044
  800387:	e8 43 03 00 00       	call   8006cf <_panic>
		if( ROUNDDOWN(myEnv->__uptr_pws[2].virtual_address,PAGE_SIZE) !=  0x804000)  panic("Page nth clock algo failed.. trace it by printing WS before and after page fault");
  ...
  8003b1:	68 b4 20 80 00       	push   $0x8020b4
  8003b6:	6a 3b                	push   $0x3b
  8003b8:	68 44 20 80 00       	push   $0x802044
  8003bd:	e8 0d 03 00 00       	call   8006cf <_panic>
		if( ROUNDDOWN(myEnv->__uptr_pws[3].virtual_address,PAGE_SIZE) !=  0x80b000)  panic("Page nth clock algo failed.. trace it by printing WS before and after page fault");
  ...
  8003e7:	68 b4 20 80 00       	push   $0x8020b4
  8003ec:	6a 3c                	push   $0x3c
  8003ee:	68 44 20 80 00       	push   $0x802044
  8003f3:	e8 d7 02 00 00       	call   8006cf <_panic>
		if( ROUNDDOWN(myEnv->__uptr_pws[4].virtual_address,PAGE_SIZE) !=  0x80c000)  panic("Page nth clock algo failed.. trace it by printing WS before and after page fault");
  ...
  80041d:	68 b4 20 80 00       	push   $0x8020b4
  800422:	6a 3d                	push   $0x3d
  800424:	68 44 20 80 00       	push   $0x802044
  800429:	e8 a1 02 00 00       	call   8006cf <_panic>
		if( ROUNDDOWN(myEnv->__uptr_pws[5].virtual_address,PAGE_SIZE) !=  0x807000)  panic("Page nth clock algo failed.. trace it by printing WS before and after page fault");
  ...
  800453:	68 b4 20 80 00       	push   $0x8020b4
  800458:	6a 3e                	push   $0x3e
  80045a:	68 44 20 80 00       	push   $0x802044
  80045f:	e8 6b 02 00 00       	call   8006cf <_panic>
		if( ROUNDDOWN(myEnv->__uptr_pws[6].virtual_address,PAGE_SIZE) !=  0x800000)  panic("Page nth clock algo failed.. trace it by printing WS before and after page fault");
  ...
  80048b:	68 b4 20 80 00       	push   $0x8020b4
  800490:	6a 3f                	push   $0x3f
  800492:	68 44 20 80 00       	push   $0x802044
  800497:	e8 33 02 00 00       	call   8006cf <_panic>
		if( ROUNDDOWN(myEnv->__uptr_pws[7].virtual_address,PAGE_SIZE) !=  0x801000)  panic("Page nth clock algo failed.. trace it by printing WS before and after page fault");
  ...
  8004c3:	68 b4 20 80 00       	push   $0x8020b4
  8004c8:	6a 40                	push   $0x40
  8004ca:	68 44 20 80 00       	push   $0x802044
  8004cf:	e8 fb 01 00 00       	call   8006cf <_panic>
		if( ROUNDDOWN(myEnv->__uptr_pws[8].virtual_address,PAGE_SIZE) !=  0x80a000)  panic("Page nth clock algo failed.. trace it by printing WS before and after page fault");
  ...
  8004f1:	3d 00 a0 80 00       	cmp    $0x80a000,%eax
  8004f6:	74 14                	je     80050c <_main+0x4d4>
  8004f8:	83 ec 04             	sub    $0x4,%esp
  8004fb:	68 b4 20 80 00       	push   $0x8020b4
  800500:	6a 41                	push   $0x41
  800502:	68 44 20 80 00       	push   $0x802044
  800507:	e8 c3 01 00 00       	call   8006cf <_panic>
		if( ROUNDDOWN(myEnv->__uptr_pws[9].virtual_address,PAGE_SIZE) !=  0x803000)  panic("Page nth clock algo failed.. trace it by printing WS before and after page fault");
  ...
  800529:	3d 00 30 80 00       	cmp    $0x803000,%eax
  80052e:	74 14                	je     800544 <_main+0x50c>
  800530:	83 ec 04             	sub    $0x4,%esp
  800533:	68 b4 20 80 00       	push   $0x8020b4
  800538:	6a 42                	push   $0x42
  80053a:	68 44 20 80 00       	push   $0x802044
  80053f:	e8 8b 01 00 00       	call   8006cf <_panic>
		if( ROUNDDOWN(myEnv->__uptr_pws[10].virtual_address,PAGE_SIZE) !=  0xeebfd000)  panic("Page nth clock algo failed.. trace it by printing WS before and after page fault");
  ...
  800561:	3d 00 d0 bf ee       	cmp    $0xeebfd000,%eax
  800566:	74 14                	je     80057c <_main+0x544>
  800568:	83 ec 04             	sub    $0x4,%esp
  80056b:	68 b4 20 80 00       	push   $0x8020b4
  800570:	6a 43                	push   $0x43
  ...
  80058f:	68 08 21 80 00       	push   $0x802108
  800594:	6a 45                	push   $0x45
  ...
  8005a3:	68 28 21 80 00       	push   $0x802128
...
libmain(int argc, char **argv)
{
  ...
  800628:	68 98 21 80 00       	push   $0x802198
  ...
  80064e:	52                   	push   %edx
  80064f:	50                   	push   %eax
  800650:	68 c0 21 80 00       	push   $0x8021c0
  ...
  80067f:	52                   	push   %edx
  800680:	50                   	push   %eax
  800681:	68 e8 21 80 00       	push   $0x8021e8
  ...
  800691:	68 98 21 80 00       	push   $0x802198
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8006ef:	50                   	push   %eax
  8006f0:	68 40 22 80 00       	push   $0x802240
  ...
  800708:	50                   	push   %eax
  800709:	68 45 22 80 00       	push   $0x802245
  ...
  80072d:	68 61 22 80 00       	push   $0x802261
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800759:	68 64 22 80 00       	push   $0x802264
  80075e:	6a 26                	push   $0x26
  800760:	68 b0 22 80 00       	push   $0x8022b0
  ...
  80082b:	68 bc 22 80 00       	push   $0x8022bc
  800830:	6a 3a                	push   $0x3a
  800832:	68 b0 22 80 00       	push   $0x8022b0
  ...
  80089b:	68 10 23 80 00       	push   $0x802310
  8008a0:	6a 44                	push   $0x44
  8008a2:	68 b0 22 80 00       	push   $0x8022b0
